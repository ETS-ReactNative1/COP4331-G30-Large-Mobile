...
export default class ExerciseSearchResultComponent extends Component {
  /*
  state = {
    isLogDeleted: false,
  ...
  async componentDidMount () {
      this.setState(({searchResultWorkouts}) => ({searchResultWorkouts: this.props.exercise}));
      //console.log(this.props.exercise);
      //console.log(this.props.date);
      //console.log(this.props.exercise.length);
  }
      ...
      <View style={styles.container}>
        <View style={styles.recreationHabit_Item}>
          ...
          >
            ...
            <View style={styles.exerciseHabit_FlatList}>
              <FlatList
                data={this.props.exercise}
                renderItem={({item}) =>
                  <Text style={styles.recreationHabit_Amount}>{item.Exercise}</Text>
                }
                keyExtractor={(item) => item._id}
                /*ItemSeparatorComponent={() =>
                  <View style={styles.exerciseHabit_Seperator}></View>
                }*/
              />
            </View>
  ...
  removeLog = async (props) =>
  {
    try
    {
      ...
      const endpoint = 'https://cop4331-g30-large.herokuapp.com/api/deleteExercise/' + global.username.trim();
  ...
  deleteLogClick = async (props) =>
  {
    Alert.alert(
      "Delete Log",
      "Are you sure you want to delete your \"Exercise\" log for " + props.date + "?",
      [
        { text: "Yes", 
