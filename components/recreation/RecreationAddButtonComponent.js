...
export default class RecreationAddButtonComponent extends Component {
  render () {
    return (
  ...
  addLogClick = async (props) =>
  {
    ...
    try
    {
      var obj = {
        ...
        hours:Number(props.timeSpent)
      };

      // Save/update water log
      const endpoint = 'https://cop4331-g30-large.herokuapp.com/api/recreation/' + global.username.trim();
